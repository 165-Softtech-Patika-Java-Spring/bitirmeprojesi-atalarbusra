package com.graduation.graduation.app.gen.service;

import com.graduation.graduation.app.gen.entity.BaseAdditionalFields;
import com.graduation.graduation.app.gen.entity.BaseEntity;
import com.graduation.graduation.app.gen.enums.GenErrorMessage;
import com.graduation.graduation.app.gen.exceptions.ItemNotFoundException;
...
public abstract class BaseEntityService<E extends BaseEntity, D extends JpaRepository<E, Long>> {
    ...
    private void setAdditionalFields(E entity) {
        ...
        if (entity.getId() == null){
            ...
            baseAdditionalFields.setCreatedBy(currentAccountId);
        }

        baseAdditionalFields.setUpdateDate(new Date());
        baseAdditionalFields.setUpdatedBy(currentAccountId);
    }
    ...
    public Long getCurrentAccountId() {
        Long currentAccountId = authenticationService.getCurrentAccountId();
